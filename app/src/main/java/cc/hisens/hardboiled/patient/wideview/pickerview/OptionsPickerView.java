...
import cc.hisens.hardboiled.patient.wideview.pickerview.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public OptionsPickerView(Context context) {
        super(context);
        View root = LayoutInflater.from(context).inflate(R.layout.layout_pickerview_options, contentContainer);
        // -----确定和取消按钮
