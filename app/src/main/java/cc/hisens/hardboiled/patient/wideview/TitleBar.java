...
//    private static final int DEFAULT_TITLE_BAR_HEIGHT = 42;
...
//        mOutPadding = dip2px(10);
        mHeight = getResources().getDimensionPixelSize(R.dimen.titlebar_height);
        mButtonBackgroundDrawable = getResources().getDrawable(R.drawable.bg_common_button_white);
        initView(context);
    }
    ...
    private void initView(Context context) {
        ...
        mCenterText.setTextSize(ScreenUtils.px2dip(getContext(), getResources().getDimensionPixelSize(R.dimen.titlebar_font_size)));
        ...
        addView(mCenterLayout, new ViewGroup.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
    ...
    public void setLeftImageResource(int resId) {
        Drawable unpressedDrawable = getResources().getDrawable(resId);
        ColorDrawable pressedDrawable = new ColorDrawable(Color.parseColor("#eeeeee"));
        StateListDrawable drawable = new StateListDrawable();
        drawable.addState(new int[]{android.R.attr.state_pressed}, pressedDrawable);
        drawable.addState(new int[]{}, unpressedDrawable);
    ...
    public void setLeftText(int resid) {
        ...
        mLeftText.setPadding((int) ScreenUtils.dp2px(getContext(), 10), 0, (int) ScreenUtils.dp2px(getContext(), 10), 0);
    }
    ...
    private View inflateAction(Action action) {
        ...
        if (TextUtils.isEmpty(action.getText())) {
            ...
            text.setTextSize(14);
            text.setPadding((int) ScreenUtils.dp2px(getContext(), 10), 0, (int) ScreenUtils.dp2px(getContext(), 10), 0);
...
//        view.setPadding(mActionPadding, 0, mActionPadding, 0);
        view.setBackgroundDrawable(mButtonBackgroundDrawable);
        view.setTag(action);
