...
import cc.hisens.hardboiled.patient.wideview.pickerview.adapter.ArrayWheelAdapter;
...
public class WheelOptions<T> {
    ...
    public void setPicker(List<T> options1Items,
        ...
        wv_option2.setVisibility(this.mOptions2Items == null ? View.GONE : View.VISIBLE);
        wv_option3.setVisibility(this.mOptions3Items == null ? View.GONE : View.VISIBLE);
