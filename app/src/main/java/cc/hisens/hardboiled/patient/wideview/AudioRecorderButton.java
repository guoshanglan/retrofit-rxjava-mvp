...
import cc.hisens.hardboiled.patient.utils.AudioDialogManager;
import cc.hisens.hardboiled.patient.utils.AudioManager;
...
public class AudioRecorderButton extends Button implements AudioManager.AudioStateListener {
    ...
    private void changeState(int state) {
        if (mCurState != state) {
            ...
            switch (state) {
                case STATE_NORMAL:
                    setBackgroundResource(R.drawable.doctor_btn_add);
                    setText(R.string.str_recorder_normal);
                    break;
                case STATE_RECORDING:
                    setBackgroundResource(R.drawable.doctor_btn_voice);
